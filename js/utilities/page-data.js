...
export const pages = [
  ...
  { url: 'views/portadas/grupales.html', label: 'Sección 4' },
  { url: 'views/otros/grupal.html', label: 'Sección 4.1' },
  { url: 'views/portadas/evaluaciones.html', label: 'Sección 5' },
  { url: 'views/otros/prueba1.html', label: 'Sección 5.1' },
  { url: 'views/portadas/anexos.html', label: 'Sección 6' },
  { url: 'views/anexos/silabo.html', label: 'Sección 6.1' },
  { url: 'views/anexos/filosofia.html', label: 'Sección 6.2' },
  { url: 'views/anexos/filosofia_carr1.html', label: 'Sección 6.2.1' },
  { url: 'views/anexos/filosofia_carr2.html', label: 'Sección 6.2.2' },
  { url: 'views/anexos/filosofia_carr3.html', label: 'Sección 6.2.3' },
  { url: 'views/portadas/referencias.html', label: 'Sección 7' },
  { url: 'views/otros/referenciasb.html', label: 'Sección 7.1' },
];
